...
def build_next_status_markdown(
    ...
    lines = [
        ...
        "- daily_hard_gate_drop_reason: 3 safe low-RAM cycles exhausted; threshold/gate tuning collapsed trades and expectancy while weekly stayed PASS",
...
def build_daily_stress_iteration_log_markdown(
    ...
    lines = [
        ...
        "- daily_stress_hard_gate: NO",
        "- daily_stress_role: INFORMATIONAL_STRETCH",
        "- daily_hard_gate_drop_reason: bounded safe loop exhausted; gate tuning repeatedly collapsed trades or expectancy",
        "- another_tuning_loop_justified: NO",
        "- chosen_next_move: OPTION_A_STOP_DAILY_AS_HARD_GATE",
