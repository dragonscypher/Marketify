...
def test_app_latest_numeric_column_value_handles_yfinance_multiindex():
    import app
    ...
    assert app._latest_numeric_column_value(frame, "Close") == 101.5
    assert app._latest_numeric_column_value(frame, "vol_20") == 0.02
